...
# extract number of spin flips for each timepoint. this should correspond to the number of active features (the change in)
spin_flips_eq_sui

# write.csv(spin_flips_eq_sui, "Sui_data_output/DF_sui_equilibrium_spin_flips.csv")
...
# resilience_indicator <- RI_recovery :: if you run the RI ver
...
```{r S simulations INDIVIDUAL item manipulation thresholds)}
...
```{r S simulations INDIVIDUAL item manipulations simulations, echo = TRUE, results = 'hide'}
...
```{r S simulations INDIVIDUAL item manipulation simulations descriptives)}
...
stateEQ_sui_14_manip_sd # 6.1759
...
stateEQ_sui_16_manip_sd # 5.17912
...
get_variable_totals <- function(df) { data.frame(variable = paste0("R", 1:ncol(df)), count = colSums(df))}
...
```{r S Ising model simulation, eval = FALSE}
...
```{r S perturbations specific}

##### self worth #####
set.seed(123456)

Glauber_2b(connectivity_resst_sui_sim, 
          thresholds_resst_sui_sim, 
          Ntime = 20000, 
          beta = 1.5,
          divider = 1000,
          nodes_to_perturb = c(1:7))

Equilibrium_sui_self_worth <- output.binary_eq 
Pertubations_sui_self_worth <- output.binary_pert
stateEQ_sui_self_worth <- mean(apply(Equilibrium_sui_self_worth,1,sum)) # mean sum of active symptoms at equilibrium 
statePERT_sui_self_worth <- mean(apply(Pertubations_sui_self_worth,1,sum))


stateEQ_sui_self_worth_sd <- sd(apply(Equilibrium_sui_self_worth,1,sum)) # sd of sum of active symptoms at equilibrium 
statePERT_sui_self_worth_sd <- sd(apply(Pertubations_sui_self_worth,1,sum)) # sd of sum of active symptoms at with perturbations

stateEQ_sui_self_worth # 5.0402
statePERT_sui_self_worth # 6.781
stateEQ_sui_self_worth_sd  # 3.969833
statePERT_sui_self_worth_sd  # 5.600143

# make dataframe with total active nodes at equilibrium and with perturbations at all timepoints (20,000)
DF_simulations_sui_self_worth <- data.frame(Timepoints = 1:Ntime,
                         Equilibrium = apply(Equilibrium_sui_self_worth,1,sum),
                         Perturbations = apply(Pertubations_sui_self_worth,1,sum)) 

data.frame(DF_simulations_sui_self_worth)

summary(DF_simulations_sui_self_worth) # look at median and interquartile range 

# plot density (active sum density) at equilibrium and with perturbation
# individual plots
ggplot(data = DF_simulations_sui_self_worth) + geom_density(aes(x=Equilibrium) , fill = "#00AFBB")
ggplot(data = DF_simulations_sui_self_worth) + geom_density(aes(x=Perturbations) , fill = "#00AFBB")
...
Glauber_2b(connectivity_resst_sui_sim, 
          ...
          beta = 1.5,
          divider = 1000,
          nodes_to_perturb = c(8:11))

Equilibrium_sui_life_worth <- output.binary_eq 
Pertubations_sui_life_worth <- output.binary_pert
stateEQ_sui_life_worth <- mean(apply(Equilibrium_sui_life_worth,1,sum)) 
statePERT_sui_life_worth <- mean(apply(Pertubations_sui_life_worth,1,sum))

stateEQ_sui_life_worth_sd <- sd(apply(Equilibrium_sui_life_worth,1,sum))  
statePERT_sui_life_worth_sd <- sd(apply(Pertubations_sui_life_worth,1,sum)) 

stateEQ_sui_life_worth # 5.0402
statePERT_sui_life_worth # 5.06655
stateEQ_sui_life_worth_sd  # 3.969833
statePERT_sui_life_worth_sd  # 4.082285

# make dataframe with total active nodes at equilibrium and with perturbations at all timepoints (20,000)
DF_simulations_sui_life_worth <- data.frame(Timepoints = 1:Ntime,
                         Equilibrium = apply(Equilibrium_sui_life_worth,1,sum),
                         Perturbations = apply(Pertubations_sui_life_worth,1,sum)) 

data.frame(DF_simulations_sui_life_worth)

summary(DF_simulations_sui_life_worth) # look at median and interquartile range 

# plot density (active sum density) at equilibrium and with perturbation
ggplot(data = DF_simulations_sui_life_worth) + geom_density(aes(x=Equilibrium) , fill = "#00AFBB")
ggplot(data = DF_simulations_sui_life_worth) + geom_density(aes(x=Perturbations) , fill = "#00AFBB")
...
Glauber_2b(connectivity_resst_sui_sim, 
          ...
          beta = 1.5,
          divider = 1000,
          nodes_to_perturb = c(12:17))

Equilibrium_sui_social_worth <- output.binary_eq 
Pertubations_sui_social_worth <- output.binary_pert
stateEQ_sui_social_worth <- mean(apply(Equilibrium_sui_social_worth,1,sum)) 
statePERT_sui_social_worth <- mean(apply(Pertubations_sui_social_worth,1,sum))

stateEQ_sui_social_worth_sd <- sd(apply(Equilibrium_sui_social_worth,1,sum))  
statePERT_sui_social_worth_sd <- sd(apply(Pertubations_sui_social_worth,1,sum)) #

stateEQ_sui_social_worth # 5.0402
statePERT_sui_social_worth # 7.58025
stateEQ_sui_social_worth_sd  # 3.969833
statePERT_sui_social_worth_sd  # 5.466668

# make dataframe with total active nodes at equilibrium and with perturbations at all timepoints (20,000)
DF_simulations_sui_social_worth <- data.frame(Timepoints = 1:Ntime,
                         Equilibrium = apply(Equilibrium_sui_social_worth,1,sum),
                         Perturbations = apply(Pertubations_sui_social_worth,1,sum)) 

data.frame(DF_simulations_sui_social_worth)

summary(DF_simulations_sui_social_worth) # look at median and interquartile range 

# plot density (active sum density) at equilibrium and with perturbation
ggplot(data = DF_simulations_sui_social_worth) + geom_density(aes(x=Equilibrium) , fill = "#00AFBB")
ggplot(data = DF_simulations_sui_social_worth) + geom_density(aes(x=Perturbations) , fill = "#00AFBB")
...
Glauber_2b(connectivity_resst_sui_sim, 
          ...
          beta = 1.5,
          divider = 1000,
          nodes_to_perturb = c(18:21))

Equilibrium_sui_self_understanding <- output.binary_eq 
Pertubations_sui_self_understanding <- output.binary_pert
stateEQ_sui_self_understanding <- mean(apply(Equilibrium_sui_self_understanding,1,sum)) 
statePERT_sui_self_understanding <- mean(apply(Pertubations_sui_self_understanding,1,sum))

stateEQ_sui_self_understanding_sd <- sd(apply(Equilibrium_sui_self_understanding,1,sum))  
statePERT_sui_self_understanding_sd <- sd(apply(Pertubations_sui_self_understanding,1,sum)) #

stateEQ_sui_self_understanding # 5.0402
statePERT_sui_self_understanding # 4.98845
stateEQ_sui_self_understanding_sd  # 3.969833
statePERT_sui_self_understanding_sd  # 3.909166

# make dataframe with total active nodes at equilibrium and with perturbations at all timepoints (20,000)
DF_simulations_sui_self_understanding <- data.frame(Timepoints = 1:Ntime,
                         Equilibrium = apply(Equilibrium_sui_self_understanding,1,sum),
                         Perturbations = apply(Pertubations_sui_self_understanding,1,sum)) 

data.frame(DF_simulations_sui_self_understanding)

summary(DF_simulations_sui_self_understanding) # look at median and interquartile range 

# plot density (active sum density) at equilibrium and with perturbation
ggplot(data = DF_simulations_sui_self_understanding) + geom_density(aes(x=Equilibrium) , fill = "#00AFBB")
ggplot(data = DF_simulations_sui_self_understanding) + geom_density(aes(x=Perturbations) , fill = "#00AFBB")

## simulation plots ##

# Perturbation #
plot1_s <- ggplot(DF_simulations_sui_self_worth, aes(x = Timepoints, y = Perturbations)) + 
  geom_line() +
  theme_classic() +
  geom_vline(xintercept = seq(from = 1000, to = Ntime - 1, by = 1000), linetype = "dashed", color = "orange", size = 0.7) +
  labs(title = "Self-worth (S)", 
       x = "",
       y = expression(paste("Recovery features"))) +
  theme(
    plot.title = element_text(family = "serif", size = 10, hjust = 0.5),
    axis.title = element_text(family = "serif", size = 10),
    axis.text = element_text(family = "serif", size = 8))

plot2_s <- ggplot(DF_simulations_sui_life_worth, aes(x = Timepoints, y = Perturbations)) + 
  geom_line() +
  theme_classic() +
  geom_vline(xintercept = seq(from = 1000, to = Ntime - 1, by = 1000), linetype = "dashed", color = "#6699FF", size = 0.7) +
  labs(title = "Life-worth (S)", 
       x = "",
       y = expression(paste(""))) +
  theme(
    plot.title = element_text(family = "serif", size = 10, hjust = 0.5),
...
plot3_s <- ggplot(DF_simulations_sui_social_worth, aes(x = Timepoints, y = Perturbations)) + 
  geom_line() +
  theme_classic() +
  geom_vline(xintercept = seq(from = 1000, to = Ntime - 1, by = 1000), linetype = "dashed", color = "#CC00CC", size = 0.7) +
  labs(title = "Social-worth (S)", 
       x = "Time points",
       y = expression(paste("Recovery features"))) +
  theme(
    plot.title = element_text(family = "serif", size = 10, hjust = 0.5),
...
plot4_s <- ggplot(DF_simulations_sui_self_understanding, aes(x = Timepoints, y = Perturbations)) + 
  geom_line() +
  theme_classic() +
  geom_vline(xintercept = seq(from = 1000, to = Ntime - 1, by = 1000), linetype = "dashed", color = "#33FF99", size = 0.7) +
  labs(title = "Self-understanding (S)", 
       x = "Time points",
       y = expression(paste(""))) +
  theme(
    plot.title = element_text(family = "serif", size = 10, hjust = 0.5),
...
# pdf("Sui_data_output/Figures/Sui_simulation_perturb_facet.pdf", width=8.75, height=5.45)
# plot1_s
# plot2_s
# plot3_s
# plot4_s
...
# density #
den_self_worth_s <- ggplot(data = DF_simulations_sui_self_worth) +
  geom_density(aes(x = Equilibrium, fill = "Equilibrium"), alpha = 0.5) +
  geom_density(aes(x = Perturbations, fill = "Perturbations"), alpha = 0.5) +
  scale_fill_manual(values = c("#C1CDCD", "orange"), name = "") +
  labs(title = "", 
       x = "", 
       y = "Density") +
  theme(panel.background = element_rect(fill = "white"),
...
den_life_s <- ggplot(data = DF_simulations_sui_life_worth) +
  geom_density(aes(x = Equilibrium, fill = "Equilibrium"), alpha = 0.5) +
  geom_density(aes(x = Perturbations, fill = "Perturbations"), alpha = 0.5) +
  scale_fill_manual(values = c("#C1CDCD", "#6699FF"), name = "") +
  labs(title = "", 
       x = "", 
       y = "") +
  theme(panel.background = element_rect(fill = "white"),
...
den_social_s <- ggplot(data = DF_simulations_sui_social_worth) +
  geom_density(aes(x = Equilibrium, fill = "Equilibrium"), alpha = 0.5) +
  geom_density(aes(x = Perturbations, fill = "Perturbations"), alpha = 0.5) +
  scale_fill_manual(values = c("#C1CDCD", "#CC00CC"), name = "") +
  labs(title = "", 
       x = "Active symptoms", 
       y = "Density") +
  theme(panel.background = element_rect(fill = "white"),
...
den_understand_s <- ggplot(data = DF_simulations_sui_self_understanding) +
  geom_density(aes(x = Equilibrium, fill = "Equilibrium"), alpha = 0.5) +
  geom_density(aes(x = Perturbations, fill = "Perturbations"), alpha = 0.5) +
  scale_fill_manual(values = c("#C1CDCD", "#33FF99"), name = "") +
  labs(title = "", 
       x = "Active symptoms", 
       y = "") +
  theme(panel.background = element_rect(fill = "white"),
...
grid.arrange(den_self_worth_s, den_life_s, den_social_s, den_understand_s, ncol = 2)

# boxplot #

boxplot_s <- ggplot() +
  geom_boxplot(data = DF_simulations_sui, aes(x = "DF_simulations_sui", y = Equilibrium), fill = "#C1CDCD") +
  geom_boxplot(data = DF_simulations_sui_self_worth, aes(x = "DF_simulations_sui_self_worth", y = Perturbations), fill = "orange") +
  geom_boxplot(data = DF_simulations_sui_life_worth, aes(x = "DF_simulations_sui_life_worth", y = Perturbations), fill = "#6699FF") +
  geom_boxplot(data = DF_simulations_sui_social_worth, aes(x = "DF_simulations_sui_social_worth", y = Perturbations), fill = "#CC00CC") +
  geom_boxplot(data = DF_simulations_sui_self_understanding, aes(x = "DF_simulations_sui_self_understanding", y = Equilibrium), fill = "#33FF99") +
  labs(title = "",
       x = "Simulations",
       y = "Active features") +
  theme(
...
RESST_no_sui_binary_items <- dplyr::select(RESST_sim_lifetime_risk_di, # binary vars
                              R1, 
                              R2, 
                              R3,
                              R4, 
...
nrow(RESST_no_sui_binary_items)
...
RESST_no_sui_binary <- IsingFit(RESST_no_sui_binary_items, plot = FALSE) 
...
spin_flips_eq_no_sui <- extract_spin_flips(output.binary_eq) # extract # of spin flips for each timpoint
spin_flips_eq_no_sui 

# write.csv(spin_flips_eq_no_sui, "No_sui_data_output/DF_no_sui_equilibrium_spin_flips.csv")
...
statePERT_no_sui <- mean(apply(Pertubations_no_sui,1,sum))  # mean sum of active symptoms  with perturbations 

stateEQ_no_sui_sd <- sd(apply(Equilibrium_no_sui,1,sum)) # sd of sum of active symptoms at equilibrium 
statePERT_no_sui_sd <- sd(apply(Pertubations_no_sui,1,sum)) # sd of sum of active symptoms with perturbations
...
# active node totals at equilibrium and with perturbations
# (DF_simulations_no_sui, "No_sui_data_output/DF_no_sui_simulations.csv") 
...
set.seed(123456)
l2 <- make_2d_Isingland(thresholds = RESST_no_sui_binary$thresholds, 
...
```{r NS simulations INDIVIDUAL item manipulation thresholds)}
# we are manipulating each symptom by 2 SD - to prefer to be more present, THEN, run at equilibrium with glaubers dynamics
...
print(manipulated_thresholds_resst_no_sui_sim1) # .-1.64
...
print(manipulated_thresholds_resst_no_sui_sim2) # .70
...
print(manipulated_thresholds_resst_no_sui_sim3) # -.55
...
print(manipulated_thresholds_resst_no_sui_sim4) # -.11
...
print(manipulated_thresholds_resst_no_sui_sim5) # -.84
...
print(manipulated_thresholds_resst_no_sui_sim6) # -.009
...
print(manipulated_thresholds_resst_no_sui_sim7) # 0.71
...
print(manipulated_thresholds_resst_no_sui_sim8) # -1.45
...
print(manipulated_thresholds_resst_no_sui_sim9) # .40
...
print(manipulated_thresholds_resst_no_sui_sim10) # 1.18
...
print(manipulated_thresholds_resst_no_sui_sim11) # -2.5
...
print(manipulated_thresholds_resst_no_sui_sim12) # -.009
...
print(manipulated_thresholds_resst_no_sui_sim13) # -.74
...
print(manipulated_thresholds_resst_no_sui_sim14) # -1.27
...
print(manipulated_thresholds_resst_no_sui_sim15) # -.33
...
print(manipulated_thresholds_resst_no_sui_sim16) # -1.63
...
print(manipulated_thresholds_resst_no_sui_sim17) # -.30
...
print(manipulated_thresholds_resst_no_sui_sim18) # .70
...
print(manipulated_thresholds_resst_no_sui_sim19) # .81
...
print(manipulated_thresholds_resst_no_sui_sim20) # 1.16
...
print(manipulated_thresholds_resst_no_sui_sim21) # .89
```

```{r NS simulations INDIVIDUAL item manipulations simulations, echo = TRUE, results = 'hide'}
# equilbrium with item 1 manipulated #
set.seed(123456)
...
```{r NS simulations INDIVIDUAL item manipulation simulations descriptives)}
...
glimpse(DF_simulations_no_sui_21m)
```
...
```{r NS Ising model simulation, eval = FALSE}
...
```{r NS perturbations specific}

##### self worth #####
set.seed(123456)

Glauber_2b(connectivity_resst_no_sui_sim, 
...
Equilibrium_no_sui_self_worth <- output.binary_eq 
Pertubations_no_sui_self_worth <- output.binary_pert
stateEQ_no_sui_self_worth <- mean(apply(Equilibrium_no_sui_self_worth,1,sum)) # mean sum of active symptoms at equilibrium 
statePERT_no_sui_self_worth <- mean(apply(Pertubations_no_sui_self_worth,1,sum))


stateEQ_no_sui_self_worth_sd <- sd(apply(Equilibrium_no_sui_self_worth,1,sum)) # sd of sum of active symptoms at equilibrium 
statePERT_no_sui_self_worth_sd <- sd(apply(Pertubations_no_sui_self_worth,1,sum)) # sd of sum of active symptoms at with perturbations

stateEQ_no_sui_self_worth # 17.67815
statePERT_no_sui_self_worth # 16.9592
stateEQ_no_sui_self_worth_sd  # 2.6569
statePERT_no_sui_self_worth_sd  # 2.887326

# make dataframe with total active nodes at equilibrium and with perturbations at all timepoints (20,000)
DF_simulations_no_sui_self_worth <- data.frame(Timepoints = 1:Ntime,
                         Equilibrium = apply(Equilibrium_no_sui_self_worth,1,sum),
                         Perturbations = apply(Pertubations_no_sui_self_worth,1,sum)) 

data.frame(DF_simulations_no_sui_self_worth)

summary(DF_simulations_no_sui_self_worth) # look at median and interquartile range 

# plot density (active sum density) at equilibrium and with perturbation
# individual plots
ggplot(data = DF_simulations_no_sui_self_worth) + geom_density(aes(x=Equilibrium) , fill = "#00AFBB")
ggplot(data = DF_simulations_no_sui_self_worth) + geom_density(aes(x=Perturbations) , fill = "#00AFBB")
...
Equilibrium_no_sui_life_worth <- output.binary_eq 
Pertubations_no_sui_life_worth <- output.binary_pert
stateEQ_no_sui_life_worth <- mean(apply(Equilibrium_no_sui_life_worth,1,sum)) 
statePERT_no_sui_life_worth <- mean(apply(Pertubations_no_sui_life_worth,1,sum))

stateEQ_no_sui_life_worth_sd <- sd(apply(Equilibrium_no_sui_life_worth,1,sum))  
statePERT_no_sui_life_worth_sd <- sd(apply(Pertubations_no_sui_life_worth,1,sum)) 

stateEQ_no_sui_life_worth # 17.67815
statePERT_no_sui_life_worth # 17.60905
stateEQ_no_sui_life_worth_sd  # 2.6569
statePERT_no_sui_life_worth_sd  # 2.727578

# make dataframe with total active nodes at equilibrium and with perturbations at all timepoints (20,000)
DF_simulations_no_sui_life_worth <- data.frame(Timepoints = 1:Ntime,
                         Equilibrium = apply(Equilibrium_no_sui_life_worth,1,sum),
                         Perturbations = apply(Pertubations_no_sui_life_worth,1,sum)) 

data.frame(DF_simulations_no_sui_life_worth)

summary(DF_simulations_no_sui_life_worth) # look at median and interquartile range 

# plot density (active sum density) at equilibrium and with perturbation
ggplot(data = DF_simulations_no_sui_life_worth) + geom_density(aes(x=Equilibrium) , fill = "#00AFBB")
ggplot(data = DF_simulations_no_sui_life_worth) + geom_density(aes(x=Perturbations) , fill = "#00AFBB")
...
Equilibrium_no_sui_social_worth <- output.binary_eq 
Pertubations_no_sui_social_worth <- output.binary_pert
stateEQ_no_sui_social_worth <- mean(apply(Equilibrium_no_sui_social_worth,1,sum)) 
statePERT_no_sui_social_worth <- mean(apply(Pertubations_no_sui_social_worth,1,sum))

stateEQ_no_sui_social_worth_sd <- sd(apply(Equilibrium_no_sui_social_worth,1,sum))  
statePERT_no_sui_social_worth_sd <- sd(apply(Pertubations_no_sui_social_worth,1,sum)) #

stateEQ_no_sui_social_worth # 17.67815
statePERT_no_sui_social_worth # 16.93035
stateEQ_no_sui_social_worth_sd  # 2.6569
statePERT_no_sui_social_worth_sd  # 3.485743

# make dataframe with total active nodes at equilibrium and with perturbations at all timepoints (20,000)
DF_simulations_no_sui_social_worth <- data.frame(Timepoints = 1:Ntime,
                         Equilibrium = apply(Equilibrium_no_sui_social_worth,1,sum),
                         Perturbations = apply(Pertubations_no_sui_social_worth,1,sum)) 

data.frame(DF_simulations_no_sui_social_worth)

summary(DF_simulations_no_sui_social_worth) # look at median and interquartile range 

# plot density (active sum density) at equilibrium and with perturbation
ggplot(data = DF_simulations_no_sui_social_worth) + geom_density(aes(x=Equilibrium) , fill = "#00AFBB")
ggplot(data = DF_simulations_no_sui_social_worth) + geom_density(aes(x=Perturbations) , fill = "#00AFBB")
...
Equilibrium_no_sui_self_understanding <- output.binary_eq 
Pertubations_no_sui_self_understanding <- output.binary_pert
stateEQ_no_sui_self_understanding <- mean(apply(Equilibrium_no_sui_self_understanding,1,sum)) 
statePERT_no_sui_self_understanding <- mean(apply(Pertubations_no_sui_self_understanding,1,sum))

stateEQ_no_sui_self_understanding_sd <- sd(apply(Equilibrium_no_sui_self_understanding,1,sum))  
statePERT_no_sui_self_understanding_sd <- sd(apply(Pertubations_no_sui_self_understanding,1,sum)) #

stateEQ_no_sui_self_understanding # 17.67815
statePERT_no_sui_self_understanding # 17.6212
stateEQ_no_sui_self_understanding_sd  # 2.6569
statePERT_no_sui_self_understanding_sd  # 2.763258

# make dataframe with total active nodes at equilibrium and with perturbations at all timepoints (20,000)
DF_simulations_no_sui_self_understanding <- data.frame(Timepoints = 1:Ntime,
                         Equilibrium = apply(Equilibrium_no_sui_self_understanding,1,sum),
                         Perturbations = apply(Pertubations_no_sui_self_understanding,1,sum)) 

data.frame(DF_simulations_no_sui_self_understanding)

summary(DF_simulations_no_sui_self_understanding) # look at median and interquartile range 

# plot density (active sum density) at equilibrium and with perturbation
ggplot(data = DF_simulations_no_sui_self_understanding) + geom_density(aes(x=Equilibrium) , fill = "#00AFBB")
ggplot(data = DF_simulations_no_sui_self_understanding) + geom_density(aes(x=Perturbations) , fill = "#00AFBB")

## simulation plots ##

# equilibrium # (same for all)
ggplot(DF_simulations_no_sui, # load 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
...
# Perturbation #
plot1_ns <- ggplot(DF_simulations_no_sui_self_worth, aes(x = Timepoints, y = Perturbations)) + 
  geom_line() +
  theme_classic() +
  geom_vline(xintercept = seq(from = 1000, to = Ntime - 1, by = 1000), linetype = "dashed", color = "orange", size = 0.7) +
  labs(title = "Self-worth (NS)", 
       x = "",
       y = expression(paste("Recovery features"))) +
  theme(
    plot.title = element_text(family = "serif", size = 10, hjust = 0.5),
...
plot2_ns <- ggplot(DF_simulations_no_sui_life_worth, aes(x = Timepoints, y = Perturbations)) + 
  geom_line() +
  theme_classic() +
  geom_vline(xintercept = seq(from = 1000, to = Ntime - 1, by = 1000), linetype = "dashed", color = "#6699FF", size = 0.7) +
  labs(title = "Life-worth (NS)", 
       x = "",
       y = expression(paste(""))) +
  theme(
    plot.title = element_text(family = "serif", size = 10, hjust = 0.5),
...
plot3_ns <- ggplot(DF_simulations_no_sui_social_worth, aes(x = Timepoints, y = Perturbations)) + 
  geom_line() +
  theme_classic() +
  geom_vline(xintercept = seq(from = 1000, to = Ntime - 1, by = 1000), linetype = "dashed", color = "#CC00CC", size = 0.7) +
  labs(title = "Social-worth (NS)", 
       x = "Time points",
       y = expression(paste("Recovery features"))) +
  theme(
    plot.title = element_text(family = "serif", size = 10, hjust = 0.5),
...
plot4_ns <- ggplot(DF_simulations_no_sui_self_understanding, aes(x = Timepoints, y = Perturbations)) + 
  geom_line() +
  theme_classic() +
  geom_vline(xintercept = seq(from = 1000, to = Ntime - 1, by = 1000), linetype = "dashed", color = "#33FF99", size = 0.7) +
  labs(title = "Self-understanding (NS)", 
       x = "Time points",
       y = expression(paste(""))) +
  theme(
    plot.title = element_text(family = "serif", size = 10, hjust = 0.5),
...
grid.arrange(plot1_ns, plot2_ns, plot3_ns, plot4_ns, ncol = 2)

#pdf("No_sui_data_output/Figures/No_sui_simulation_perturb_facet.pdf", width=8.75, height=5.45)
plot1_ns
plot2_ns
plot3_ns
plot4_ns
...
den_self_worth_ns <- ggplot(data = DF_simulations_no_sui_self_worth) +
  geom_density(aes(x = Equilibrium, fill = "Equilibrium"), alpha = 0.5) +
  geom_density(aes(x = Perturbations, fill = "Perturbations"), alpha = 0.5) +
  scale_fill_manual(values = c("#C1CDCD", "orange"), name = "") +
  labs(title = "", 
...
den_life_ns <- ggplot(data = DF_simulations_no_sui_life_worth) +
  geom_density(aes(x = Equilibrium, fill = "Equilibrium"), alpha = 0.5) +
  geom_density(aes(x = Perturbations, fill = "Perturbations"), alpha = 0.5) +
  scale_fill_manual(values = c("#C1CDCD", "#6699FF"), name = "") +
  labs(title = "", 
...
den_social_ns <- ggplot(data = DF_simulations_no_sui_social_worth) +
  geom_density(aes(x = Equilibrium, fill = "Equilibrium"), alpha = 0.5) +
  geom_density(aes(x = Perturbations, fill = "Perturbations"), alpha = 0.5) +
  scale_fill_manual(values = c("#C1CDCD", "#CC00CC"), name = "") +
  labs(title = "", 
...
den_understand_ns <- ggplot(data = DF_simulations_no_sui_self_understanding) +
  geom_density(aes(x = Equilibrium, fill = "Equilibrium"), alpha = 0.5) +
  geom_density(aes(x = Perturbations, fill = "Perturbations"), alpha = 0.5) +
  scale_fill_manual(values = c("#C1CDCD", "#33FF99"), name = "") +
  labs(title = "", 
...
grid.arrange(den_self_worth_ns, den_life_ns, den_social_ns, den_understand_ns, ncol = 2)

# boxplot #

boxplot <- ggplot() +
  geom_boxplot(data = DF_simulations_no_sui, aes(x = "DF_simulations_no_sui", y = Equilibrium), fill = "#C1CDCD") +
  geom_boxplot(data = DF_simulations_no_sui_self_worth, aes(x = "DF_simulations_no_sui_self_worth", y = Perturbations), fill = "orange") +
  geom_boxplot(data = DF_simulations_no_sui_life_worth, aes(x = "DF_simulations_no_sui_life_worth", y = Perturbations), fill = "#6699FF") +
  geom_boxplot(data = DF_simulations_no_sui_social_worth, aes(x = "DF_simulations_no_sui_social_worth", y = Perturbations), fill = "#CC00CC") +
  geom_boxplot(data = DF_simulations_no_sui_self_understanding, aes(x = "DF_simulations_no_sui_self_understanding", y = Equilibrium), fill = "#33FF99") +
  labs(title = "",
       x = "Active features",
       y = "Value") +
  theme(
...
df_totals_equil <- data.frame(
  TotalOccurrences_No_Sui = rowSums(Equilibrium_no_sui),
  TotalOccurrences_Sui = rowSums(Equilibrium_sui))

variable_names <- paste("V", seq_along(df_totals_equil$Variable), sep = "")

df_totals_equil_1 <- data.frame(
  Variable = variable_names,
  df_totals_equil[, c("TotalOccurrences_No_Sui", "TotalOccurrences_Sui")]
)

print(df_totals_equil_1)
...
max_time_points <- 5000 # change based on visual ease
...
for (i in 1:21) {
  ...
  current_plot <- ggplot(combined_df, aes(x = Timepoints, y = Equilibrium, color = Type)) +
    ...
    scale_x_continuous(breaks = c(0, 2500, 5000), limits = c(0, max_time_points))
...
```{r B Overlap original and manipulated (individual) equilibrium boxplot}

custom_colors <- c("#3300FF", "#00CCFF", "#663399", "#CC99FF")

plot_list <- list()

max_time_points <- 20000 # change based on visual ease
...
for (i in 1:21) {
  ...
  combined_df <- rbind(
    transform(get(df_name_ori), Type = paste("S")),
    transform(get(df_name_sui), Type = paste("S", i, "m")),
    transform(get(df_name_no_sui), Type = paste("NS", i, "m")),
    transform(get(df_name_no_sui_ori), Type = paste("NS"))
  )
  
  current_plot <- ggplot(combined_df, aes(x = Type, y = Equilibrium, fill = Type)) +
    geom_boxplot() +
    ...
    theme(
      plot.title = element_text(family = "serif", size = 8, hjust = 0.5),
      axis.title = element_blank(), 
      axis.text = element_text(family = "serif", size = 5),
      legend.position = "none"  
    )
