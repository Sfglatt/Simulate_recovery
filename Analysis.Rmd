...
# plot density (active sum density) at each equilibrium items' manipulation
# List of data frames
df_list <- list(DF_simulations_sui_1m, DF_simulations_sui_2m, DF_simulations_sui_3m, DF_simulations_sui_4m, DF_simulations_sui_5m, DF_simulations_sui_6m, DF_simulations_sui_7m, DF_simulations_sui_8m, DF_simulations_sui_9m, DF_simulations_sui_10m, DF_simulations_sui_11m, DF_simulations_sui_12m, DF_simulations_sui_13m, DF_simulations_sui_14m, DF_simulations_sui_15m, DF_simulations_sui_16m, DF_simulations_sui_17m, DF_simulations_sui_18m, DF_simulations_sui_19m, DF_simulations_sui_20m, DF_simulations_sui_21m)
...
for (i in seq_along(df_list)) {
  plot <- ggplot(df_list[[i]], aes(x = Equilibrium)) +
    geom_density(fill = colors[i], alpha = 0.5) +
    geom_density(data = DF_simulations_sui, aes(x = Equilibrium), fill = "grey", alpha = 0.5) +
    ...
    theme(plot.title = element_text(family = "serif", size = 8, hjust = 0.5))
...
write.csv(total_manipulated_s, 'Sui_data_output/DF_sui_equilibrium_manipulated_totals.csv')
```
...
write_xlsx(combined_data_all, 'C:\\Users\\sofel\\OneDrive\\Documents\\Labs\\PASE-R Lab\\RESST network\\Simulations_FSA\\DF_equilibrium_sui_manipulated_total_equil.xlsx')
...
EQ_1m <- ggplot(DF_simulations_sui_1m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 1", 
  ...
  theme(
    ...
    axis.title = element_text(family = "serif",size = 6,  ),
    axis.text = element_text(family = "serif",size = 6)) +   scale_x_continuous(breaks = c(0, 10000, 20000)) 
EQ_1m

EQ_2m <- ggplot(DF_simulations_sui_2m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 2", 
...
EQ_3m <- ggplot(DF_simulations_sui_3m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 3", 
...
EQ_4m <- ggplot(DF_simulations_sui_4m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 4", 
...
EQ_5m <- ggplot(DF_simulations_sui_5m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 5", 
...
EQ_6m <- ggplot(DF_simulations_sui_6m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 6", 
...
EQ_7m <- ggplot(DF_simulations_sui_7m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 7", 
...
EQ_8m <- ggplot(DF_simulations_sui_8m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 8", 
...
EQ_9m <- ggplot(DF_simulations_sui_9m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 9", 
...
EQ_10m <- ggplot(DF_simulations_sui_10m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 10", 
...
EQ_11m <- ggplot(DF_simulations_sui_11m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 11", 
...
EQ_12m <- ggplot(DF_simulations_sui_12m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 12", 
...
EQ_13m <- ggplot(DF_simulations_sui_13m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 13", 
...
EQ_14m <- ggplot(DF_simulations_sui_14m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 14", 
...
EQ_15m <- ggplot(DF_simulations_sui_15m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 15", 
...
EQ_16m <- ggplot(DF_simulations_sui_16m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 16", 
...
EQ_17m <- ggplot(DF_simulations_sui_17m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 17", 
...
EQ_18m <- ggplot(DF_simulations_sui_18m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 18", 
...
EQ_19m <- ggplot(DF_simulations_sui_19m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 19", 
...
EQ_20m <- ggplot(DF_simulations_sui_20m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 20", 
...
EQ_21m <- ggplot(DF_simulations_sui_21m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 21", 
...
plots <- list(EQ_1m, EQ_2m, EQ_3m, EQ_4m, EQ_5m, EQ_6m, EQ_7m, EQ_8m, EQ_9m, EQ_10m, EQ_11m, EQ_12m, EQ_13m, EQ_14m, EQ_15m, EQ_16m, EQ_17m, EQ_18m, EQ_19m, EQ_20m, EQ_21m)
...
## plots at equilibrium ## 
EQ_ns_1m <- ggplot(DF_simulations_no_sui_1m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 1", 
...
EQ_ns_2m <- ggplot(DF_simulations_no_sui_2m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 2", 
...
EQ_ns_3m <- ggplot(DF_simulations_no_sui_3m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 3", 
...
EQ_ns_4m <- ggplot(DF_simulations_no_sui_4m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 4", 
...
EQ_ns_5m <- ggplot(DF_simulations_no_sui_5m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 5", 
...
EQ_ns_6m <- ggplot(DF_simulations_no_sui_6m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 6", 
...
EQ_ns_7m <- ggplot(DF_simulations_no_sui_7m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 7", 
...
EQ_ns_8m <- ggplot(DF_simulations_no_sui_8m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 8", 
...
EQ_ns_9m <- ggplot(DF_simulations_no_sui_9m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 9", 
...
EQ_ns_10m <- ggplot(DF_simulations_no_sui_10m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 10", 
...
EQ_ns_11m <- ggplot(DF_simulations_no_sui_11m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 11", 
...
EQ_ns_12m <- ggplot(DF_simulations_no_sui_12m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 12", 
...
EQ_ns_13m <- ggplot(DF_simulations_no_sui_13m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 13", 
...
EQ_ns_14m <- ggplot(DF_simulations_no_sui_14m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 14", 
...
EQ_ns_15m <- ggplot(DF_simulations_no_sui_15m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 15", 
...
EQ_ns_16m <- ggplot(DF_simulations_no_sui_16m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 16", 
...
EQ_ns_17m <- ggplot(DF_simulations_no_sui_17m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 17", 
...
EQ_ns_18m <- ggplot(DF_simulations_no_sui_18m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 18", 
...
EQ_ns_19m <- ggplot(DF_simulations_no_sui_19m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 19", 
...
EQ_ns_20m <- ggplot(DF_simulations_no_sui_20m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 20", 
...
EQ_ns_21m <- ggplot(DF_simulations_no_sui_21m, 
       aes(x = Timepoints, y = Equilibrium)) + 
  geom_line() +
  theme_classic() +
  labs(title = "Item 21", 
...
plots <- list(EQ_ns_1m, EQ_ns_2m, EQ_ns_3m, EQ_ns_4m, EQ_ns_5m, EQ_ns_6m, EQ_ns_7m, EQ_ns_8m, EQ_ns_9m, EQ_ns_10m, EQ_ns_11m, EQ_ns_12m, EQ_ns_13m, EQ_ns_14m, EQ_ns_15m, EQ_ns_16m, EQ_ns_17m, EQ_ns_18m, EQ_ns_19m, EQ_ns_20m, EQ_ns_21m)
...
```{r Glauber dynamics equilibrium  totals sui and no sui}

totals_no_sui <- colSums(Equilibrium_no_sui) # total occurrences for each symptom non-suicide group
totals_sui <- colSums(Equilibrium_sui) # total occurrences for each symptom in suicide group
...
write.csv(df_totals_equil, 'Both_sui_data_output/DF_sui_no_sui_equilibrium_symptom_totals.xlsx') # file with total number of active features for both groups
