...
```{r simulations INDIVIDUAL manipulations total}
...
```{r simulations individual pre and post manipulation}
...
```{r individual manipulation simulation plots}
...
```{r individual manipulations system activity preferences}
# connectivity_resst_sui_sim = RESST_sui_binary_res$weiadj 
